...
!function (e, t) {
    ...
    var e, a, i, V = {
        ...
        touch: Y.Modernizr && !0 === Y.Modernizr.touch || !!(0 < Y.navigator.maxTouchPoints || "ontouchstart" in Y || Y.DocumentTouch && f instanceof Y.DocumentTouch),
                ...
                for (var E, S = t.slidesPerColumn, C = x / S, M = Math.floor(d / t.slidesPerColumn), k = 0; k < d; k += 1) {
                    ...
                    if ("none" !== P.css("display")) {
                        if ("auto" === t.slidesPerView) {
                            ...
                            D && (P[0].style.transform = "none"), O && (P[0].style.webkitTransform = "none"), T = t.roundLengths ? e.isHorizontal() ? P.outerWidth(!0) : P.outerHeight(!0) : e.isHorizontal() ? parseFloat(I.getPropertyValue("width")) + parseFloat(I.getPropertyValue("padding-left")) + parseFloat(I.getPropertyValue("padding-right")) + parseFloat(I.getPropertyValue("margin-left")) + parseFloat(I.getPropertyValue("margin-right")) : parseFloat(I.getPropertyValue("height")) + parseFloat(I.getPropertyValue("padding-top")) + parseFloat(I.getPropertyValue("padding-bottom")) + parseFloat(I.getPropertyValue("margin-top")) + parseFloat(I.getPropertyValue("margin-bottom")), D && (P[0].style.transform = D), O && (P[0].style.webkitTransform = O), t.roundLengths && (T = Math.floor(T))
    ...
    var H = {
        ...
        getDistanceBetweenTouches: function (e) {
            ...
            i.$imageEl && 0 !== i.$imageEl.length && (a.scale = F.gestures ? e.scale * a.currentScale : i.scaleMove / i.scaleStart * a.currentScale, a.scale > i.maxRatio && (a.scale = i.maxRatio - 1 + Math.pow(a.scale - i.maxRatio + 1, .5)), a.scale < t.minRatio && (a.scale = t.minRatio + 1 - Math.pow(t.minRatio - a.scale + 1, .5)), i.$imageEl.transform("translate3d(0,0,0) scale(" + a.scale + ")"))
